    ...
    <>
      <div className="mx-auto max-w-2xl">
        ...
        <HeaderSection
          ...
          subtitle="Join thousands of junior developers, start interviewing with confidence today."
        />
      </div>
              ...
              <div>
                ...
                <div className="relative z-10 mt-8 space-y-1.5 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Advanced AI technology analyzes your responses in real-time,
                    providing detailed feedback on technical accuracy,
            ...
            <div className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 sm:col-span-3 lg:col-span-2">
              <div>
                ...
                <div className="relative z-10 mt-8 space-y-1.5 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Track your interview performance with comprehensive metrics,
                    identifying strengths and areas for improvement across
                    technical, behavioral, and communication skills.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      Access role-specific interview questions curated by
                      industry experts and continuously updated to match hiring
                      trends.
                    </p>
                  </div>
                </div>
            ...
            <div className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 lg:col-span-3">
              <div className="grid h-full sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    <h2 className="text-lg font-medium text-foreground">
                      Resume-Tailored Practice
                    </h2>
                    <p className="text-muted-foreground">
                      Our AI analyzes your resume to generate optimal answers to
                      help you prepare for questions about your specific skills.
                    </p>
                  </div>
                </div>
