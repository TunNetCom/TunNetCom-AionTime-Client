    ...
    <section className="py-20">
      <MaxWidthWrapper>
        <div className="mx-auto max-w-2xl">
          <HeaderSection
            label="AI-Powered DevOps Management"
            title="Sync, Chat, and Manage Work Effortlessly with AionTime Agent"
            subtitle="Connect Azure DevOps and Jira. Chat with your project data. Let our AI agent create, assign, and update work items—so you can focus on what matters."
          />
        </div>
        ...
        <div className="relative z-10 mt-12 grid grid-cols-6 gap-3">
          ...
          <div className="relative col-span-full flex overflow-hidden rounded-2xl border bg-background p-8 lg:col-span-2">
            <div className="relative m-auto size-fit">
              ...
              <h2 className="mt-6 text-center font-heading text-3xl md:text-4xl lg:text-[40px]">
                Teams boost productivity with AionTime
              </h2>
              <p className="mt-2 text-center text-muted-foreground">
                Connect your DevOps stack, automate busywork, and focus on
                high-impact work. AionTime users report faster delivery and
            ...
            <div>
                  ...
                  <defs>
                    ...
                    <clipPath id="clip0_0_1">
                      <rect
                        ...
                        height="72"
                        fill="white"
                        className="fill-cyan-500 opacity-100"
              ...
              <div className="relative z-10 mt-8 space-y-1.5 text-center">
                ...
                <p className="text-muted-foreground">
                  We use the latest encryption and security practices to
                  ensure your data is safe and secure, and we are working on
                  SOC 2 compliance and will uphold the highest standards of
                  security.
                </p>
              </div>
            </div>
          ...
          <div className="relative col-span-full overflow-hidden rounded-2xl border bg-background p-8 sm:col-span-3 lg:col-span-2">
            <div>
              ...
              <div className="relative z-10 mt-8 space-y-1.5 text-center">
                <h2 className="text-lg font-medium text-foreground">
                  Unified Ticketing & Automation
                </h2>
                <p className="text-muted-foreground">
                  Manage all your work items from one place. Let AionTime
                  handle the busywork—sync, automate, and stay in control with
                  a single AI-powered workspace.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid sm:grid-cols-2">
              <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Connect your Azure DevOps or Jira in minutes. No complex
                    onboarding—just instant productivity.
                  </p>
                </div>
              </div>
              <div className="relative -mb-10 -mr-10 mt-8 h-fit rounded-tl-xl border bg-muted/30 pt-6 sm:ml-6 sm:mt-auto">
                ...
                <svg
                  className="w-full text-cyan-600/60 sm:w-[150%]"
                  viewBox="0 0 366 231"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
            ...
            <div className="grid h-full sm:grid-cols-2">
              <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-muted-foreground">
                    Work with your team in one place. Assign, discuss, and
                    resolve tickets together—powered by AI and seamless
                    integrations.
                  </p>
                </div>
              </div>
              <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-cyan-500/50 sm:-my-8 sm:-mr-8">
