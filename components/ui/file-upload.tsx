    ...
    <div className="w-full" {...getRootProps()}>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center">
          <p className="relative z-[2] font-sans text-base font-bold text-neutral-700 dark:text-neutral-300">
            Upload file
          </p>
          <p className="relative z-[2] mt-2 font-sans text-base font-normal text-neutral-400 dark:text-neutral-400">
            ...
            {files.length > 0 &&
              files.map((file, idx) => (
                <motion.div
                  ...
                  className={cn(
                    "relative z-[3] mx-auto mt-4 flex w-full flex-col items-start justify-start overflow-hidden rounded-md bg-white p-4 dark:bg-neutral-900 md:h-24",
                    "shadow-sm",
                  )}
                >
                  <div className="flex w-full items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="rounded-full p-1 hover:bg-red-100 dark:hover:bg-red-900/50"
